...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    rowner: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Filtur untuk khusus developer 
╰─────────────────֍`,
    owner: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Perintah hanya untuk owner bot
╰─────────────────֍`,
    mods: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Filtur hanya untuk moderator 
╰─────────────────֍`,
    premium: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Filtur hanya untuk pengguna premium
╰─────────────────֍`,
    group: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Fitur khusus di dalam grup
╰─────────────────֍`,
    private: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Filtur hanya untuk di gunakan di privat 
╰─────────────────֍`,
    admin: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Fitur khusus admin grup!!
╰─────────────────֍`,
    botAdmin: `╭─❑┃ＳＰＥＣＩＡＬ ＡＣＣＥＳＳ┃❑─
╠ Jadikan Bot ke admin terlebih dahulu
╰─────────────────֍`,
 ...
 let unreg = {
  unreg: `
┏━━━〔 ❖ *REGISTER* ❖ 〕━━❑
┃╠Hallo gaes👋, @${m.sender.split`@`[0]}
┃╠Yok daftar dulu, agar bisa akses filtur bot nya
┃╠Klik Button di bawah yah,
┃╠Jika Tidak muncul button ikuti contoh di bawah
┃╠contoh: #daftar nama.umur
┃╠#daftar @${m.sender.split`@`[0]}.18
┗━━━━━━━━━━━━━━━━━━❑`
  }[type]
 if (unreg) return conn.sendBut(m.chat, unreg, '❑ Silahkan Klik Button di bawah ❑', 'Daftar', `.daftar @${m.sender.split`@`[0]}.18`, m)
 }
